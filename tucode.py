...
class board:
    def __init__(self, pits, quan_pits, board):
        ...
        self._endgame = False   
        self.pit_radius = 30  # Bán kính ô dân
        self.quan_width, self.quan_height = 60, 80  # Kích thước ô quan
        ...
        self.pit_border_color = (120, 90, 40)  # Nâu đậm hơn
        self.pit_fill_color = (250, 230, 200)  # Màu be sáng
        self.quan_fill_color = (255, 220, 160)  # Màu cam nhạt
        self.text_color = (20, 20, 20)  # Màu chữ rõ hơn
